...
<nav class="nav d-flex justify-content-between subbar" >
  ...
  <a href="tincture.php" class="btn btn-secondary  btn-lg">Tinctures</a>
    <a href="topical.php" class="btn btn-secondary btn-lg active">Topicals</a>
        	...
        	<div class="row">
        		...
        		<div class="shop col-sm-3 smolchonk">
        			 <ul class="list-group mb-1">
        			 	<li><img class="card-img-top micro" src="img/top_sm.jpg" alt="Card image cap"></li>
        		...
        		<div class="shop col-sm-8 chonk">	
        			...
        			<p class="lead">Select from the drop down lists below to start building your very own custom blend. If you have any questions about the ingredients check out the Mini Guide popup buttons below!</p>
						...
						<select >
							...
							<option >Capsacin</option>
						    <option  >Tiger Blend</option>
						    
						    
						    <option >Balm Blend</option>
						    <option >Restore Blend</option>
						    <option >Royal Bee Pollen</option>
						</select>
						<hr>
						<select >
						    <option selected>Volume</option>
						   <option >1 oz $15</option>
							<option >2 oz $25</option>
						    <option  >4oz - $40</option>
						    
						    
						    <option >8 oz - $60</option>
						</select>
						<hr>
						 <button class="btn-lg end add">Add to cart</button>
						 <button class="btn-lg end clear">Empty Cart</button>
						 <hr>
						We use 100% organic, vegan ingredients (except our Pollen Blend), all contents are mixed with organic coconut oil as a binding medium then homogenized to ensure evenly distributed contents. Other binding contents can be arranged for special allergy restrictions on <a href="faq.php"> request</a>.<br>For more information on the ingredients used in your custom blend, check out the Mini guide popup buttons below!
