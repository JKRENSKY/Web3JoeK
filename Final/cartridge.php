...
<nav class="nav d-flex justify-content-between subbar" >
  ...
  <a href="cartridge.php" class="btn btn-secondary active btn-lg">Cartridges</a>
        	...
        	<div class="row">
        		...
        		<div class="shop col-sm-3 smolchonk">
        			 <ul class="list-group mb-1">
        			 	<li><img class="card-img-top micro" src="img/cart_sm.jpg" alt="Card image cap"></li>
        		...
        		<div class="shop col-sm-8 chonk">	
        			...
        			<p class="lead">Select from the drop down lists below to start building your very own custom blend. If you have any questions about the ingredients check out the Mini Guide popup buttons below!</p>
						...
						<select >
							...
							<option >500ml - $40</option>
						    <option  >1000ml - $60</option>
						...
						<hr>
						 ...
						 <hr>
						Designed for maximum aromatic quality, our cartridges are built to vaporize your custom blend with flavor and preservation in mind. Our cartridges are quality tested and produced in the USA. We use a 50/50 PG/VG mix. Different blend amounts can be arranged at <a href="faq.php"> request</a>.<br>For more information on the ingredients used in your custom blend, check out the Mini guide popup buttons below!
